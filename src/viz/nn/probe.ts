...
export interface Probe {
  ...
  /** Stands both spheres on the floor at input `p`. */
...
/** Above the flat floor and boundary layers, as the chain-rule spheres are. */
const ORDER = 10;
 ...
 * either way. Same recipe as `chain-rule/points.ts`.
 */
