...
/**
 * The "home" camera for a surface: looking at the centre of its domain at the
 ...
 */
export function frameFor(surface: Surface, heightRange: readonly [number, number]): Framing {
